---
title: "Finalyze"
description: "A React Native mobile app for tracking personal expenses and managing budgets with smart categorization and visual analytics."
techStack:
  - TypeScript
  - React Native
  - Expo
...
1. Efficient SQLite queries for fast dashboard loading
2. Intuitive category selection and expense input flow
3. Responsive chart rendering across different screen sizes
4. Smart categorization algorithm for expense suggestions
